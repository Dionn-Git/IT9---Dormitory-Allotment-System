    ...
    <div class="flex flex-col h-full">
        ...
        <div class="flex flex-col py-4 px-2 space-y-5">
            <x-nav-link :href="route('employee.dashboard')" :active="request()->routeIs('employee.dashboard')">
                ...
                <span class="text-xl">{{ __('Dashboard') }}</span>
            </x-nav-link>

            <x-nav-link :href="route('employee.residents')" :active="request()->routeIs('employee.residents')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 mr-3">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                </svg>
                <span class="text-xl">{{ __('Residents') }}</span>
            </x-nav-link>

            <x-nav-link :href="route('employee.rooms')" :active="request()->routeIs('employee.rooms')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 mr-3">
            ...
            <x-nav-link :href="route('employee.payments')" :active="request()->routeIs('employee.payments')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 mr-3">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
                </svg>
                <span class="text-xl">{{ __('Payments') }}</span>
            </x-nav-link>

            <x-nav-link :href="route('employee.concerns')" :active="request()->routeIs('employee.concerns')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8 mr-3">
            ...
            <x-nav-link :href="route('employee.history')" :active="request()->routeIs('employee.history')">
                ...
                <span class="text-xl">{{ __('History') }}</span>
            </x-nav-link>
